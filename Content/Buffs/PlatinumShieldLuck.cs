...
namespace ShatteredRealm.Content.Buffs
{
	...
	public class PlatinumShieldLuck : ModBuff
	{
		...
		{
			player.GetModPlayer<PlatinumShieldBuffPlayer>().shield = true;
		}
	}

	public class PlatinumShieldBuffPlayer : ModPlayer
	{
		// Flag checking when life regen debuff should be activated
		public bool lifeRegenBuff;
		public int FrameCounter = 0;
		public bool shield; //Booster shot (equipped)
