...
namespace ShatteredRealm.Content.Buffs
{
	...
	public class BoosterShot : ModBuff
	{
		...
		{
			player.GetModPlayer<BoosterShotRegenBuffPlayer>().verdantBoosterShot = true;
		}
	}

	public class BoosterShotRegenBuffPlayer : ModPlayer
	{
		// Flag checking when life regen debuff should be activated
		public bool lifeRegenBuff;
		public int FrameCounter = 0;
		public bool verdantBoosterShot; //Booster shot (equipped)
