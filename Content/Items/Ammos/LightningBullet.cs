...
{
	public class LightningBullets : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<LightningBulletsProj>(); // The projectile that weapons fire when using this item as ammunition.
    ...
    public class LightningBulletsProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
