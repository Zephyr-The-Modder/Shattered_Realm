...
namespace ShatteredRealm.Content.Prefixes.Shield
{
    ...
    public class PrefixWeaponized : ModPrefix
    {
        ...
        {
            item.shieldItem().durability = (int)(item.shieldItem().durability * 0.95f);
            item.shieldItem().cooldown = (int)(item.shieldItem().cooldown * 1.05f);
        }
