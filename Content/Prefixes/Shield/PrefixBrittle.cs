...
namespace ShatteredRealm.Content.Prefixes.Shield
{
    ...
    public class PrefixBrittle : ModPrefix
    {
        ...
        {
            item.shieldItem().durability = (int)(item.shieldItem().durability * 0.7f);
            item.shieldItem().cooldown = (int)(item.shieldItem().cooldown * 1.15f);
        }
